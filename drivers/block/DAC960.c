...
{
	return single_open(file, dac960_initial_status_proc_show, inode->i_private);
}
...
{
	return single_open(file, dac960_current_status_proc_show, inode->i_private);
}
...
{
	return single_open(file, dac960_user_command_proc_show, inode->i_private);
}
...
{
  DAC960_Controller_T *Controller = (DAC960_Controller_T *) file->f_path.dentry->d_inode->i_private;
