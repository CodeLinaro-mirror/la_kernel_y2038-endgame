...
static int cfctrl_cmd_link_setup(struct cfctrl *cfctrl, struct cfpkt *pkt, u8 cmdrsp)
{
	...
	struct cfctrl_link_param *linkparam = &rsp.param;
...
static int cfctrl_recv(struct cflayer *layer, struct cfpkt *pkt)
{
	...
	case CFCTRL_CMD_LINK_SETUP:
		ret = cfctrl_cmd_link_setup(cfctrl, pkt, cmdrsp);
		break;
