...
typedef void copy_user_page_t(void *, const void *, unsigned long,
			      struct page *);

struct cpu_user_fns {
	void (*cpu_clear_user_highpage)(struct page *page, unsigned long vaddr);
	copy_user_page_t *cpu_copy_user_page;
...
extern void __cpu_copy_user_page(void *to, const void *from,
				 unsigned long user, struct page *);
...
#define copy_user_page(to,from,vaddr,pg)	\
	__cpu_copy_user_page(to, from, vaddr, pg)
