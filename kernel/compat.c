...
int get_compat_itimerval(struct itimerspec64 *o, const struct compat_itimerval __user *i)
{
	...
	if (v32.it_interval.tv_usec >= USEC_PER_SEC ||
...
int put_compat_itimerval(struct compat_itimerval __user *o, const struct itimerspec64 *i)
{
	struct compat_itimerval v32;
...
int put_compat_rusage(const struct __kernel_rusage *r,
