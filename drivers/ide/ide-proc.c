...
{
	return single_open(file, ide_imodel_proc_show, inode->i_private);
}
...
{
	return single_open(file, ide_mate_proc_show, inode->i_private);
}
...
{
	return single_open(file, ide_channel_proc_show, inode->i_private);
}
...
{
	return single_open(file, ide_identify_proc_show, inode->i_private);
}
...
{
	return single_open(file, ide_settings_proc_show, inode->i_private);
}
...
{
	ide_drive_t	*drive = (ide_drive_t *) file->f_path.dentry->d_inode->i_private;
	char		name[MAX_LEN + 1];
...
{
	return single_open(file, ide_geometry_proc_show, inode->i_private);
}
...
{
	return single_open(file, ide_dmodel_proc_show, inode->i_private);
}
...
{
	return single_open(file, ide_driver_proc_show, inode->i_private);
}
...
{
	return single_open(file, ide_media_proc_show, inode->i_private);
}
