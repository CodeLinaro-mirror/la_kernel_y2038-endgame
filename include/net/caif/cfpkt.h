...
static noinline_if_stackbloat u8 cfpkt_extr_head_u8(struct cfpkt *pkt)
{
	u8 tmp;
...
static noinline_if_stackbloat u16 cfpkt_extr_head_u16(struct cfpkt *pkt)
{
	__le16 tmp;
...
static noinline_if_stackbloat u32 cfpkt_extr_head_u32(struct cfpkt *pkt)
{
	__le32 tmp;
