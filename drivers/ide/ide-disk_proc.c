...
{
	return single_open(file, idedisk_cache_proc_show, inode->i_private);
}
...
{
	return single_open(file, idedisk_capacity_proc_show, inode->i_private);
}
...
{
	return single_open(file, idedisk_sv_proc_show, inode->i_private);
}
...
{
	return single_open(file, idedisk_st_proc_show, inode->i_private);
}
