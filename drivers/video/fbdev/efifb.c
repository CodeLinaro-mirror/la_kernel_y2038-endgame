...
#else
static inline void efifb_show_boot_graphics(struct fb_info *info, struct screen_info *si) {}
#endif
...
static int efifb_setup(char *options, struct screen_info *si)
{
	char *this_opt;
...
static int efifb_probe(struct platform_device *dev)
{
	...
	par->linelength = si->lfb_linelength;
	par->width = si->lfb_width;
	par->height = si->lfb_height;
	par->depth = si->lfb_depth;
