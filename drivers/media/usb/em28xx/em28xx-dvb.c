...
static noinline_if_stackbloat int em28xx_attach_xc3028(u8 addr, struct em28xx *dev)
{
...
static noinline_if_stackbloat int em28174_dvb_init_pctv_460e(struct em28xx *dev)
{
	struct em28xx_dvb *dvb = dev->dvb;
...
static noinline_if_stackbloat int em28178_dvb_init_pctv_461e(struct em28xx *dev)
{
	struct em28xx_dvb *dvb = dev->dvb;
	struct i2c_client *client;
...
static noinline_if_stackbloat int em28178_dvb_init_pctv_292e(struct em28xx *dev)
{
	struct em28xx_dvb *dvb = dev->dvb;
...
static noinline_if_stackbloat int em28178_dvb_init_terratec_t2_stick_hd(struct em28xx *dev)
{
	struct em28xx_dvb *dvb = dev->dvb;
	struct i2c_adapter *adapter;
	struct i2c_client *client;
...
static noinline_if_stackbloat int em28178_dvb_init_plex_px_bcud(struct em28xx *dev)
{
	struct em28xx_dvb *dvb = dev->dvb;
	struct i2c_client *client;
	struct i2c_board_info info;
...
static noinline_if_stackbloat int em28174_dvb_init_hauppauge_wintv_dualhd_dvb(struct em28xx *dev)
{
	struct em28xx_dvb *dvb = dev->dvb;
	struct i2c_adapter *adapter;
	struct i2c_client *client;
