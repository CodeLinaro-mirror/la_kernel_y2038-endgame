		...
		struct __kernel_timespec __user *,tp)
{
	...
	switch (which_clock) {
	case CLOCK_REALTIME: ktime_get_real_ts64(&kernel_tp); break;
	case CLOCK_MONOTONIC: ktime_get_ts64(&kernel_tp); break;
	case CLOCK_BOOTTIME: get_monotonic_boottime64(&kernel_tp); break;
...
COMPAT_SYSCALL_DEFINE4(clock_nanosleep, const clockid_t, which_clock,
		       int, flags,
		       ...
		       struct compat_timespec __user *, rmtp)
{
	...
	if (compat_get_timespec64(&t64, rqtp))
		return -EFAULT;
