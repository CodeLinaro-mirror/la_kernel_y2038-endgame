					   ...
					   bool set)
{
	...
	cmd_resp->addr_high = cpu_to_le32(high_16_bits((u64)(uintptr_t)lut));
	cmd_resp->addr_low = cpu_to_le32(lower_32_bits((u64)(uintptr_t)lut));
				      ...
				      bool set)
{
	...
	cmd_resp->addr_high = cpu_to_le32(high_16_bits((u64)(uintptr_t)key));
	cmd_resp->addr_low = cpu_to_le32(lower_32_bits((u64)(uintptr_t)key));
